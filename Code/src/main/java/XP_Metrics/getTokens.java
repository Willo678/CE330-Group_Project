    ...
    public static ArrayList<Token> getTokens(String path) {
        ...
        try (Scanner scanner = new Scanner(new File(path))) {
            ...
            while (scanner.hasNextLine()) {
                ...
                lineNum++;
                newLine = line.replaceAll("([\"']).*(\\1)+|[^a-zA-Z0-9{}\"/']+", " ");

                for (String statement : newLine.split(";")) {
...
//        tokens.getTokens("Code/src/main/java/XP_Metrics/getTokens.java");
//        for (Token token : tokens.getTokens("Code/src/main/java/XP_Metrics/getTokens.java")) {
