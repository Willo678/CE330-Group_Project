...
import XP_Metrics.IndentationChecker;
import XP_Metrics.classChecker;
import XP_Metrics.functionChecker;
...
public class targetSelectionUI extends JFrame {
    ...
    private String analyzeJavaFile(File javaFile) {
        ...
        try {
            ...
            ArrayList<Tokeniser.Token> tokens = tokeniser.preprocess(javaFile.getAbsolutePath());

            double classScore = XP_Metrics.classChecker.checkClassStructure(tokens);
            double functionScore = XP_Metrics.functionChecker.checkFunctionStructure(tokens);
            double indentationScore = XP_Metrics.IndentationChecker.checkIndentation(tokens);
